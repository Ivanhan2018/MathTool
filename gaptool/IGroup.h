...
IDHelper::IDHelper(){
	...
	//G28
	m_N0.insert(make_pair("1,1,14,6,6,0",1));
	m_N0.insert(make_pair("1,1,2,6,6,12",2));
	m_N0.insert(make_pair("1,15,0,6,6,0",3));	
	m_N0.insert(make_pair("1,3,0,6,18,0",4));	
	//G30
	...
	//G80	
	m_N0.insert(make_pair("1,1,2,4,4,4,40,8,16,0",1));
	m_N0.insert(make_pair("1,1,2,4,4,4,8,8,16,32",2));
	m_N0.insert(make_pair("1,1,2,4,20,4,40,8,0,0",3));
	m_N0.insert(make_pair("1,11,12,4,24,4,0,8,16,0",4));
	m_N0.insert(make_pair("1,11,12,4,24,4,0,8,16,0",5));
	m_N0.insert(make_pair("1,21,22,4,4,4,0,8,16,0",6));
	m_N0.insert(make_pair("1,41,2,4,4,4,0,8,16,0",7));
	m_N0.insert(make_pair("1,1,42,4,4,4,0,8,16,0",8));
	m_N0.insert(make_pair("1,3,4,4,40,12,0,16,0,0",9));
	m_N0.insert(make_pair("1,3,4,4,40,12,0,16,0,0",10));
	m_N0.insert(make_pair("1,3,44,4,0,12,0,16,0,0",11));
	m_N0.insert(make_pair("1,3,44,4,0,12,0,16,0,0",12));
	m_N0.insert(make_pair("1,3,44,4,0,12,0,16,0,0",13));
	m_N0.insert(make_pair("1,23,24,4,0,12,0,16,0,0",14));
	m_N0.insert(make_pair("1,25,2,4,20,20,0,8,0,0",15));
	m_N0.insert(make_pair("1,5,22,4,20,20,0,8,0,0",16));
	m_N0.insert(make_pair("1,21,6,4,20,4,0,24,0,0",17));
	m_N0.insert(make_pair("1,1,26,4,20,4,0,24,0,0",18));
	m_N0.insert(make_pair("1,7,40,4,0,28,0,0,0,0",19));
	m_N0.insert(make_pair("1,3,12,4,0,12,0,48,0,0",20));
	m_N0.insert(make_pair("1,7,8,4,0,28,0,32,0,0",21));
	m_N0.insert(make_pair("1,3,12,4,0,12,0,48,0,0",22));
	m_N0.insert(make_pair("1,3,4,4,8,12,0,16,32,0",23));
	m_N0.insert(make_pair("1,3,4,4,8,12,0,16,32,0",24));
	m_N0.insert(make_pair("1,9,2,4,4,36,0,8,16,0",25));
	m_N0.insert(make_pair("1,5,6,4,4,20,0,24,16,0",26));
	m_N0.insert(make_pair("1,1,10,4,4,4,0,40,16,0",27));
	m_N0.insert(make_pair("1,11,12,4,40,4,0,8,0,0",28));
	m_N0.insert(make_pair("1,11,12,4,40,4,0,8,0,0",29));
	m_N0.insert(make_pair("1,11,52,4,0,4,0,8,0,0",30));
	m_N0.insert(make_pair("1,11,52,4,0,4,0,8,0,0",31));
	m_N0.insert(make_pair("1,3,20,4,40,12,0,0,0,0",32));
	m_N0.insert(make_pair("1,3,20,4,40,12,0,0,0,0",33));
	m_N0.insert(make_pair("1,23,40,4,0,12,0,0,0,0",34));
	m_N0.insert(make_pair("1,3,44,4,0,12,0,16,0,0",35));
	m_N0.insert(make_pair("1,23,24,4,0,12,0,16,0,0",36));
	m_N0.insert(make_pair("1,43,4,4,0,12,0,16,0,0",37));
	m_N0.insert(make_pair("1,23,24,4,0,12,0,16,0,0",38));
	m_N0.insert(make_pair("1,35,12,4,0,20,0,8,0,0",39));
	m_N0.insert(make_pair("1,15,32,4,0,20,0,8,0,0",40));
	m_N0.insert(make_pair("1,11,36,4,0,4,0,24,0,0",41));
	m_N0.insert(make_pair("1,31,16,4,0,4,0,24,0,0",42));
	m_N0.insert(make_pair("1,7,40,4,0,28,0,0,0,0",43));
	m_N0.insert(make_pair("1,27,20,4,0,28,0,0,0,0",44));
	m_N0.insert(make_pair("1,7,8,4,0,28,0,32,0,0",45));
	m_N0.insert(make_pair("1,11,4,4,0,44,0,16,0,0",46));
	m_N0.insert(make_pair("1,3,12,4,0,12,0,48,0,0",47));
	m_N0.insert(make_pair("1,7,8,4,0,28,0,32,0,0",48));
	m_N0.insert(make_pair("1,15,0,64,0,0,0,0,0,0",49));
	m_N0.insert(make_pair("1,23,40,4,0,12,0,0,0,0",50));
	m_N0.insert(make_pair("1,47,0,4,0,28,0,0,0,0",51));
	m_N0.insert(make_pair("1,15,0,4,0,60,0,0,0,0",52));	
	//G80
	m_S2.insert(make_pair("0,11,145,10,180,94,240,800,720,960",30));
	m_kKEZDCANS.insert(make_pair("20,[4,0,4,12,0,0,0,0,0,0],20,4,5,0,0,0,1",30));
	//G84
	m_N0.insert(make_pair("1,1,14,14,14,6,28,6,0,0,0,0",1));
	m_N0.insert(make_pair("1,1,14,2,14,6,28,6,0,12,0,0",2));
	m_N0.insert(make_pair("1,1,2,6,2,6,0,6,12,36,12,0",3));
	m_N0.insert(make_pair("1,1,2,14,2,6,28,6,12,0,12,0",4));
	m_N0.insert(make_pair("1,1,2,42,2,6,0,6,12,0,12,0",5));
	m_N0.insert(make_pair("1,1,2,2,2,6,4,6,12,12,12,24",6));
	m_N0.insert(make_pair("1,15,14,0,42,6,0,6,0,0,0,0",7));
	m_N0.insert(make_pair("1,31,2,0,14,6,0,18,12,0,0,0",8));
	m_N0.insert(make_pair("1,3,14,0,42,6,0,18,0,0,0,0",9));
	m_N0.insert(make_pair("1,3,8,0,0,6,0,18,48,0,0,0",10));
	m_N0.insert(make_pair("1,3,56,0,0,6,0,18,0,0,0,0",11));
	m_N0.insert(make_pair("1,15,2,0,30,6,0,6,12,0,12,0",12));
	m_N0.insert(make_pair("1,7,2,0,2,6,0,42,12,0,12,0",13));
	m_N0.insert(make_pair("1,43,2,0,2,6,0,6,12,0,12,0",14));
	m_N0.insert(make_pair("1,3,2,0,6,6,0,18,12,0,36,0",15));
	//G90	
